		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					<a href="javascript:void(0)" class="dropDown_A">${name }<i class="Hui-iconfont">&#xe6d5</i></a>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="usertoList.do" data-title="会员列表" href="javascript:;">会员列表</a></li>
			</ul>
		</dd>
	</dl>
</div>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="/ssm/welcome.jsp"></iframe>
	</div>
</div>
</section>
