...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i>首页<span class="c-gray en">&gt;</span> <a href="usertoList.do">会员管理</a> <span class="c-gray en">&gt;</span> 查询结果</nav>
	<div class="text-c"> 
		...
		<tbody id="user">
		   <c:forEach  items="${SR}" var = 'U'>
			<tr id="userTR" class="text-c">
				...
				<td>${U.email }</td>
				<td> ${U.des} </td>
				<td><fmt:formatDate value="${U.jointime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td class="td-manage"> <a title="编辑" href="memberedit.do?uid=${U.uid}"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
				<a title="删除" href="javascript:void(0)"  onclick="member_del(this,${U.uid})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
		   </c:forEach >
		</tbody>
	</table>
